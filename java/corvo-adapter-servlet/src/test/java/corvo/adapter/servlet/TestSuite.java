...
public final class TestSuite {
    ...
    public static void main(String[] args) throws Exception {
        ...
        CorvoServlet servlet = new CorvoServlet(Corvo.app()
                .quiet()
    ...
    private static void enrutado(CorvoServlet servlet) throws Exception {
    ...
    private static void parametros(CorvoServlet servlet) throws Exception {
    ...
    private static void sesionYGalletas(CorvoServlet servlet) throws Exception {
    ...
    private static void respuestas(CorvoServlet servlet) throws Exception {
    ...
    private static void errores(CorvoServlet servlet) throws Exception {
    ...
    private static void contextPath(CorvoServlet servlet) throws Exception {
    ...
    private static Doble.Respuesta llamar(CorvoServlet servlet, Doble.Peticion peticion)
            throws Exception {
