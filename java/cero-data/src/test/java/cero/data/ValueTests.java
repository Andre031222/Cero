...
final class ValueTests {
    ...
    private static void filas() {
        Row row = Row.of("id", 7, "titulo", "Cero", "activo", true, "precio", "12.50");

        Check.equal("get devuelve el valor", row.get("titulo"), "Cero");
        ...
        Row mayusculas = Row.of("ID", 7L, "TITULO", "Cero", "PAGINAS", 10);
        Check.equal("busca sin distinguir mayúsculas", mayusculas.text("titulo"), "Cero");
        Check.that("has tampoco distingue", mayusculas.has("id") && mayusculas.has("Id"));
        Check.equal("y vincula igual a un record",
                mayusculas.as(Articulo.class), new Articulo(7L, "Cero", 10));
        ...
        Check.equal("as vincula a un record",
                Row.of("id", 1L, "titulo", "Cero", "paginas", 10).as(Articulo.class),
                new Articulo(1L, "Cero", 10));
