...
public final class TestSuite {
    ...
    public static void main(String[] args) throws Exception {
        System.out.println();
        System.out.println("── cero-web, el sitio de punta a punta");
    ...
    private static void portada(String base) throws Exception {
        ...
        comprobar("con el título de la página", portada.body().contains("<title>Cero —"));
    ...
    private static void cabecerasYEstaticos(String base) throws Exception {
        ...
        HttpResponse<String> css = get(base + "/estaticos/cero.css");
    ...
    private static void acceso(String base) throws Exception {
        ...
        HttpResponse<String> malas = form(base + "/auth/login", cookie,
                "_csrf=" + token + "&email=demo@cero.dev&password=incorrecta");
    ...
    private static void generador(String base) throws Exception {
        ...
        comprobar("y nombre de archivo",
                zip.headers().firstValue("content-disposition").orElse("").contains("mi-tienda-cero.zip"));
     ...
     *
     * <p>Estuvo clavado a mano en «0.3.0» y sobrevivió al renombrado: cada `cero new` creaba
    ...
    private static void versionDelProyectoGenerado() throws Exception {
        ...
        java.nio.file.Path base = java.nio.file.Files.createTempDirectory("cero-version");
        ...
        comprobar("el pom generado pide la versión actual de cero-core",
                pom.contains("<artifactId>cero-core</artifactId>\n            <version>" + esperada));
    ...
    /** {@code cero new … --front} tiene que dejar un backend que ya hable con un frontend aparte. */
    private static void generadorConFrontend() throws Exception {
        java.nio.file.Path base = java.nio.file.Files.createTempDirectory("cero-front");
