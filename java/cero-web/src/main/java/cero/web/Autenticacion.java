...
import cero.core.OAuth;
import cero.core.Passwords;
import cero.core.Principal;
...
public final class Autenticacion {
    ...
    private static final String CORREO_DEMO = "demo@cero.dev";
    private static final String NOMBRE_DEMO = "Usuario de demostración";
    private static final String HASH_DEMO = Passwords.hash("cero123");
    ...
    public static Autenticacion desde(Config config) {
        String id = config.get("cero.oauth.google.id", "");
        String secreto = config.get("cero.oauth.google.secreto", "");
        String redireccion = config.get("cero.oauth.google.redireccion",
    ...
    /** Lo que Cero llama en cada petición para saber quién viene. */
