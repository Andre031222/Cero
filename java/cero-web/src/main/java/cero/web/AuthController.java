...
import cero.core.Log;
import cero.core.OAuth;
import cero.core.Post;
import cero.core.RequireAuth;
...
public class AuthController {
    ...
    public Result formulario(Context contexto) {
        ...
        Map<String, Object> modelo = Vista.modelo(contexto, "Iniciar sesión · Cero");
    ...
    public Result perfil(Context contexto) {
        Map<String, Object> modelo = Vista.modelo(contexto, "Mi perfil · Cero");
