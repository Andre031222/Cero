# Migrar una aplicación de LuxCore o Corvo a Cero 0.6.0
...
Esta guía es para llevar una aplicación de 0.2.x, 0.3.x o 0.4.0 a **0.6.0**, que es la
primera que se publica. El guion
...
| Versión | `0.2.x` / `0.3.x` / `0.4.0` | `0.6.0` |
